...
description: "Plan ahead so heirs know what to do with the home, belongings, documents, contacts, and wishes before they are overwhelmed."
page_id: "prearranged"
...
This is not estate planning and it does not replace an attorney, CPA, financial advisor, insurance professional, or healthcare planning. It is the practical home-and-belongings plan that heirs often wish existed.
...
<div class="ld-practical-grid">
  <article>
    ...
    <h2>The Home</h2>
    <p>Access, utilities, maintenance notes, insurance concerns, vendors, recurring bills, likely repairs, and immediate stabilization steps.</p>
  </article>
  <article>
    <span><i class="fas fa-boxes-stacked" aria-hidden="true"></i></span>
    <h2>Belongings</h2>
    <p>Sentimental items, likely donations, possible sale items, family distribution wishes, storage needs, and items that should not be discarded.</p>
  </article>
  <article>
    <span><i class="fas fa-address-book" aria-hidden="true"></i></span>
    <h2>Contacts</h2>
    <p>Family decision makers, attorney, CPA, realtor, lender, insurance agent, contractors, neighbors, helpers, and preferred vendors.</p>
  </article>
  <article>
...
| Home & Belongings Walkthrough | $1,500-$3,500 | A parent or family who wants the house, contacts, and sentimental priorities documented |
