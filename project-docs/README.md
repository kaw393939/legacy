...
- `content/` for page and structured content
- `templates/` for HTML structure
- `static/` for source CSS, JavaScript, and images
- `tools/` for repeatable build and QA utilities
- `.github/workflows/` for deployment and preview checks
